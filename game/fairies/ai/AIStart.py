...
from . import FairiesAIRepository
...
for i in range(1, 20+1):
    ...
    if i==1 or os.getenv("want_district_%s" % i):
        ...
        if platform.system() == "Windows":
            os.system(f"title Pixie Hollow - AI ({districtName})")
...
print("-"*30, "creating fairies district %s" % districtNumber, "-"*30)

simbase.air = FairiesAIRepository.FairiesAIRepository(
        simbase.mdip,
        simbase.mdport,
        simbase.esip,
        simbase.esport,
